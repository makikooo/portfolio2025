...
<?php get_header(); ?>
  <main id="detail">  
    <section class="sec01">
        ...
        <h4 class="detail_section_title">架空喫茶店サイト No.2</h4>
        <div class="border"></div>

        <div class="images_wrapper">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/coffee02.webp" alt="">
        </div>
        <a href="https://happy-smile-design.info/cafe_dummy/" target="_blank" class="detail_subtitle">架空喫茶店サイト</a>
        <p class="detail_link"><a target="_blank" href="https://happy-smile-design.info/cafe_dummy/">( https://happy-smile-design.info/cafe_dummy/ )</a></p>
        ...
        <table class="content_table">
            <tr>
                <th>ご依頼内容</th>
                <td>就労支援にて利用者さんのデザインをもとにHTML、CSS、WordPressを実装の練習です。</td>
            </tr>
            <tr>
                <th>ページ数</th>
                <td>トップページ含み3ページ</td>
        ...
        <p class="detail_text">
            HTMLから作りオリジナルテーマ開発を実装し、ブロックエディタでも使えるように工夫しました。
        </p>
        <dl>
            <dt>【マルチデバイス対応】</dt>
        ...
        <div class="button_wrapper">
            <a class="work_button go_to_site_button" href="https://happy-smile-design.info/cafe_dummy/" target="_blank">
