...
<?php get_header(); ?>
    <main id="works-page">
      <section class="title_wrapper">
          <h3 class="section_title">WORKS  <span>作品・実績</span></h3>
      </section>
      <section class="sec02">
        <ul class="works_list">
            ...
            <div class="work_link_wrapper" data-category="wordpress">
                <div class="link_flex">
                    <div class="work_wrapper">
                        <img loading="lazy" class="work_image" src="<?php echo get_template_directory_uri(); ?>/assets/images/renewal-our-sle.webp" alt="制作内容のイメージ画像">
                        <div class="work_box">
                            <h5 class="work_title">
                                <span>
                                リニューアル わたしたちのSLE
                            ...
                            <p class="code">
                                HTML, CSS, JavaScript, PHP, Claude
                            </p>
                            <p class="production_date">制作日 2026年6月</p>
                        </div>
                    </div>
                    <div class="button_wrapper">
                        <a class="work_button detail_button" href="/renewal-our-sle/">
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="production_date">制作日 2025年6月</p>
                        </div>
                    </div>
                    <div class="button_wrapper">
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="activity">個人活動</p>
                            <p class="code">
                                HTML, CSS, JavaScript, <br class="sp_only">PHP,WordPress
                            </p>
                            <p class="production_date">制作日 2025年3月</p>
                        </div>
                    </div>
                    <div class="button_wrapper">
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="activity">個人活動</p>
                            <p class="code">
                                HTML, CSS, JavaScript, <br class="sp_only">
                                PHP,WordPress
                            </p>
                            <p class="production_date">制作日 2025年3月</p>
                        </div>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <div class="category">LP</div>
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2024年9月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                JavaScript
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <div class="category">LP</div>
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2024年2月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                JavaScript(GSAP)
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="production_date">制作日 2024年4月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                JavaScript(GSAP), WordPress
                            </p>
                        </div>
                    </div>
                    <div class="button_wrapper">
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2024年</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                JavaScript(GSAP), PHP
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <div class="category">Webデザイン・HP</div>
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2023年</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                JavaScript(JQuery)
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2025年1月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                バニラJavaScript
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <div class="category">Webアプリ</div>
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2024年11月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                バニラJavaScript
                            </p>
                ...
                <div class="link_flex">
                    <div class="work_wrapper">
                        ...
                        <div class="work_box">
                            ...
                            <div class="category">Webアプリ</div>
                            <p class="activity">個人活動</p>
                            <p class="production_date">制作日 2024年8月</p>
                            <p class="code">
                                HTML, CSS,<br class="sp_only">
                                バニラJavaScript
                            </p>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">Webアプリ</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2024年6月</p>
                                <p class="code">
                                    HTML, CSS,<br class="sp_only">
                                    バニラJavaScript
                                </p>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">LP</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2023年6月</p>
                                <p class="code">
                                    HTML, CSS,<br class="sp_only">
                                    バニラJavaScript
                                </p>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">Webアプリ</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2023年5月</p>
                                <p class="code">
                                    HTML, CSS,<br class="sp_only">
                                    バニラJavaScript
                                </p>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">Webアプリ</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2023年4月</p>
                                <p class="code">
                                    HTML, CSS,<br class="sp_only">
                                    バニラJavaScript
                                </p>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">LP</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2023年1月</p>
                                <p class="code">
                                    HTML, CSS
                                </p>
                            </div>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <p class="production_date">制作日 2022年12月</p>
                                <p class="code">
                                    HTML, CSS, <br class="sp_only">JavaScript
                                </p>
                            </div>
                        </div>
                        <div class="button_wrapper">
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">LP</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2022年11月</p>
                                <p class="code">
                                    HTML, CSS
                                </p>
                            </div>
                    ...
                    <div class="link_flex">
                        <div class="work_wrapper">
                            ...
                            <div class="work_box">
                                ...
                                <div class="category">LP</div>
                                <p class="activity">個人活動</p>
                                <p class="production_date">制作日 2022年10月</p>
                                <p class="code">
                                    HTML, CSS, <br class="sp_only">
                                    JavaScript
                                </p>
